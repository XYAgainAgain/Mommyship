...
While piloting D.A.V.E., the pilot uses their own Stats and Skills to operate its systems, weapons, and utilities, but does not need to roll to lift objects up to 5,000kg or use the Jetpack, and gains [+] on Strength Checks. D.A.V.E. is also equipped with 12 hours of O2.
...
<img src="Assets/Sheets/DAVE.png" alt="D.A.V.E. — Light Sheet" class="character-sheet">
</div>
<div class="sheet-pair__col">
<img src="Assets/Sheets/DARK-DAVE.png" alt="D.A.V.E. — Dark Sheet" class="character-sheet">
</div>
</div>
...
**Basic Installation (500kcr):** Install a standard weapon (sold separately) in a Softpoint™ slot. When installed, the weapon's Range increases by one (Adjacent → Close → Long → Extreme) to a maximum of Extreme and it gains [+] on Damage rolls.

**Premium Installation (2mcr):** Install one of the following options:

- **Acid Slinger:** Long. Light. Energy Cells, 1 shot. 2d10 DMG (Corrosive). Affects target & all Close; acid remains a stationary hazard inflicting 1d10 DMG/turn on touch for 1d5 rounds.
...
- **Infrared Array:** Allows the pilot to see heat signatures, sometimes up to several hours old.
...
- **Cloaking Unit:** [+] on Speed Checks to move unseen or evade notice, and obscures D.A.V.E.'s heat signature on infrared sensors.
