...
|         Chem-caster         | 900cr  | Ranged |  Tech   |                           Close. 1 DMG. Gunshot. If DMG dealt: administers a chem of choice that shooter has on hand to target.                           |   Special    |
...
|          EMP Rifle          | 1.8kcr | Ranged |  Tech   |                                 Long. 1d10 DMG. If target is Mech, Body Save [-] shuts down until repairs & hard reboot.                                  | Energy Cell  |
...
|        Laser Cutter         | 1.5kcr | Ranged |  Heavy  |                              Long. 1d100 DMG. 6 shots. Bleeding [+] or Gore [+]. Two-handed. 1 round recharge between shots.                              | Energy Cells |
...
|         Mind Melter         | 1.5kcr | Ranged | Psychic |      Close. 1d10 DMG. Blunt Force. If DMG dealt: enemy must Sanity Save or go catatonic for 1d10 rounds. Does not work on Mechs. Requires Powercell.      |     N/A      |
...
|       Rocket Launcher       |  4kcr  | Ranged |  Heavy  |                                 Long. 4d10 DMG (AA). 1 shot. Fire & Explosives. Can only be fired at Long Range targets.                                  | Heavy Shells |
|         Smart Rifle         |  5kcr  | Ranged |  Tech   |                                 Extreme. 3d10 DMG (AA). 3 shots. Gunshot [+]. [-] on STR Check when fired at Close Range.                                 | Energy Cells |
...
|        Sniper Rifle         |  4kcr  | Ranged |  Light  |                                         Extreme. 3d10 DMG. Gunshot. Critical: Deals 3 WOUNDS instead of DMG roll.                                         | Light Rounds |
...
|         Vibrosword          |  2kcr  | Melee  |  Heavy  |                                                              Adjacent. 2d10 DMG (AA). Gore.                                                               |     N/A      |
...
|     Battle Vaccsuit     |  5kcr  |  6  | 12 hrs |         5 hours, Patch Kit, ZG, JR, MR.          |                                                      Includes short-range comms, headlamp, ×1 Patch Kit. Speed [-] when worn. Radiation shielding. Decompression once AP is 0.                                                      |
| Standard Infantry Armor |  7kcr  |  7  |   No   |         6 hours, Assorted Tools, MR [+].         |                                                                                                Includes SR comms, headlamp, bodycam.                                                                                                |
|        Cybersuit        | 11kcr  |  8  |   No   |      6 hours, Assorted Tools, MR or CN [+].      |                                                                                    Includes short-range comms, HUD, built-in Computer Terminal.                                                                                     |
| Assault Infantry Armor  | 16kcr  |  9  |  1 hr  |           6 hours, Assorted Tools, MR.           |                                              Includes short-range comms, headlamp, body cam, air filter (separate from O2 supply). Resistant to chemical and fire damage while intact.                                              |
|     Black Ops Armor     | 25kcr  | 10  | 6 hrs  |       12 hours, Assorted Tools, MR or Inf.       |                                                     Includes radio jammer, stimpack auto-injector (stimpacks sold separately), radiation shielding. Decompression once AP is 0.                                                     |
| Powered Infantry Armor  | 35kcr  | 12  | 2 hrs  |           12 hours, Machine Shop, MR.            | Includes short-range comms, headlamp, body cam, air filter (separate from O2 supply), exoskeleton. Completely immune to radiation, chemical and fire damage while intact. Speed [-], Strength [+] when worn. Decompression at 0 AP. |
...
| Emergency Beacon | 2kcr | Equipment | A small device that sends up a flare and then emits a loud beep every few seconds. Additionally, sends out a call on all radio channels to ships or vehicles in the area, but can be blocked by a radio jammer. |
...
| Explosives & Detonator | 500cr | Equipment | Explosive charge powerful enough to blow open an airlock. All organisms in Close Range must make a Body Save or take a Wound (Explosive). Detonator works at Long Range, but can be blocked by a radio jammer. |
...
| Radio Jammer | 4kcr | Equipment | Rucksack-sized device which, when activated, renders all radio signals within 100km incomprehensible. |
...
| Short-Range Comms | 100cr | Equipment | Allows communication from ship-to-ship within a reasonable distance, as well as surface-to-surface within a dozen kilometers. Blocked by radio jammers. |
