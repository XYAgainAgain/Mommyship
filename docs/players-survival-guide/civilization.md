...
3. **Convert Stress into Saves and/or Stats.** For every point of Stress you convert, you can improve any Save or Stat by one. You can divide these improvements up however you want. If you're somehow chilling at Minimum Stress (usually 2), you can still convert that Stress, but as soon as Shore Leave ends, it returns to its minimum.
...
While the Warden is in charge of creating them and assigning their stats, Contractors should generally be controlled by the player who hired them or by any player who doesn't have a character present in the scene currently. This helps keep everyone engaged.
